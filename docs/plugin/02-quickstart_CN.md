...
{ Chinese | [English](02-quickstart.md) }
...
2. **[快速开始](02-quickstart_CN.md)** ← 当前文档
...
1.  [深入了解插件系统架构](03-architecture_CN.md)
2.  [查看完整的 API 参考](04-api-reference_CN.md)
3.  [学习 OneBot API 使用](05-onebot-guide_CN.md)
4.  [掌握配置与数据管理](06-config-data_CN.md)
...
**上一篇**: [← 插件系统概述](01-overview_CN.md)  
**下一篇**: [插件系统架构 →](03-architecture_CN.md)
