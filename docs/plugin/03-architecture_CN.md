...
{ Chinese | [English](03-architecture.md) }
...
3. **[插件系统架构](03-architecture_CN.md)** ← 当前文档
...
1.  [查看完整的 API 参考](04-api-reference_CN.md)
2.  [学习 OneBot API 使用](05-onebot-guide_CN.md)
3.  [掌握配置与数据管理](06-config-data_CN.md)

---

**上一篇**: [← 快速开始](02-quickstart_CN.md)  
**下一篇**: [插件 API 参考 →](04-api-reference_CN.md)
